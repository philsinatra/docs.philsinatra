import { Figure, Layout } from '../components/'

export const meta = {
  date: '2020-08-26',
  title: 'The Latest in CSS',
}
...
- Hapuarachchi, Rumesh Eranga "Improve Page Rendering Speed Using Only CSS", 09-12-2020, [https://blog.bitsrc.io/improve-page-rendering-speed-using-only-css-a61667a16b2](https://blog.bitsrc.io/improve-page-rendering-speed-using-only-css-a61667a16b2)
